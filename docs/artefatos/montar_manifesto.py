...
def bloco_2_xtts():
    ...
    return {
        ...
        "resultado": "parcial",
        "afirmacao": ("O ajuste fino produz um sotaque misto: tracos paraibanos passam a "
                      "aparecer, mas convivem com o padrao do checkpoint base."),
...
def bloco_5_fishspeech():
    ...
    return {
        ...
        "estrategia": "Ajuste fino",
        "resultado": "parcial",
        "afirmacao": ("Apos uma epoca de ajuste fino (LoRA), o sotaque paraibano e "
                      "percebido em parte das amostras, nao em todas."),
        "descricao": ("Mesmo prompt de voz de referencia nas duas colunas. O resultado e "
                      "irregular por construcao: em algumas frases a adaptacao e audivel, "
                      "em outras nao. Ouca as cinco antes de concluir. Pagina completa: "
