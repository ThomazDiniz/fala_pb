...
```bash
docker container run --rm -it --gpus=all -v C:/path/to/F5-TTS/data:/workspace/F5-TTS/data -v C:/path/to/F5-TTS/ckpts:/workspace/F5-TTS/ckpts -p 7860:7860 ghcr.io/swivid/f5-tts:main f5-tts_finetune-gradio --host 0.0.0.0
```

**Finetune com cache:**

```bash
docker container run --rm -it --gpus=all -v C:/path/to/F5-TTS/data:/workspace/F5-TTS/data -v C:/path/to/F5-TTS/ckpts:/workspace/F5-TTS/ckpts -v C:/path/to/.cache/huggingface:/root/.cache/huggingface -p 7860:7860 ghcr.io/swivid/f5-tts:main f5-tts_finetune-gradio --host 0.0.0.0
```
...
C:/path/to/coqui-ai-TTS/refs/ref_a1.wav
```
