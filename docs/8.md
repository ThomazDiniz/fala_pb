...
Duração dos audios extraidos da Base:
Total de duração: 450402.65 segundos (125.11 horas)

Vale ressaltar que ainda não fiz uma limpeza. (Pode ser que tenham falas que não estejam inteligiveis, audios com barulhos e multifalantes)
...
### Outros audios de referência
<audio controls src="../audios/base/sample2.wav"></audio>
<audio controls src="../audios/base/sample3.wav"></audio>
<audio controls src="../audios/base/sample4.wav"></audio>
<audio controls src="../audios/base/sample5.wav"></audio>