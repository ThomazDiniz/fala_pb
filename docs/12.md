...
![F5-TTS Loss](12/f5tts_loss.png)
*Figura: `f5tts_loss.png`.*

![F5-TTS Loss by epoch](12/f5tts_loss_by_epoch.png)
...
![XTTS training loss](12/xtts_training_loss_from_trainer_logs.png)
...
| Texto | Áudio |
|---|---|
| O ceú de campina grande ficou alaranjado no fim da tarde | <audio controls src="12/infer1.wav"></audio> |
| A cidade de campina grande realmente é grade | <audio controls src="12/infer2.wav"></audio> |
