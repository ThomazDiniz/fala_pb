...
| Texto | Áudio |
|---|---|
| O ceú de campina grande ficou alaranjado no fim da tarde | <audio controls src="infer1.wav"></audio> |
| A cidade de campina grande realmente é grade | <audio controls src="infer2.wav"></audio> |
